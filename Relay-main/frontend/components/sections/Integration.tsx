            ...
            <div className="framer-b7vr65" data-framer-name="Heading">
                ...
                <div className="framer-vhonp" data-framer-name="Main">
                  <div className="framer-1g18l5z" data-framer-name="Alpha Range Technology" data-framer-component-type="RichTextContainer" style={{transform: "none"}}>
                    <h2 className="framer-text framer-styles-preset-mnfyzd" data-styles-preset="muXEgmE57">
                      {"Bring Systems Together Keep Work in Motion."}
                    </h2>
                  </div>
                </div>
              </div>
              <div className="framer-10obiw3" data-framer-name="Subtext" data-framer-component-type="RichTextContainer" style={{transform: "none"}}>
                <p className="framer-text framer-styles-preset-1xv0u9n" data-styles-preset="VsDceC7bv" style={{"--framer-text-color": "var(--token-e77749d5-1f11-472b-b926-5090d7e5b50e, rgb(176, 190, 217))"}}>
                  Bring your apps, services, APIs, and data together through one intelligent integration layer that keeps workflows moving automatically.
                </p>
              </div>
            </div>
